...
'''
IMPORTANT 2 doesn't apply for tflite version I think, I had PyInstaller a compiling error regarding this part
...
current_model_path = os.path.join(dir_path, "models/tflite", "_7-5f-lstm_model_7.tflite")
...
def main():
    ...
    gest_clsf = TFLiteGestureClassifier(model_path=current_model_path)
    ...
    while True:
        ...
        cv.imshow('5F TFLite - MediaPipe Holistic Demo', debug_image)
