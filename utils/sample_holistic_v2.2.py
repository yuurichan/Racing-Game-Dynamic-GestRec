...
def is_landmark_in_connection(connection, landmark):
    return landmark.value not in connection \
           #and not (PoseLandmark.LEFT_SHOULDER in connection and PoseLandmark.RIGHT_SHOULDER in connection)


def draw_hands_landmarks_(
        image,
        cx,
        cy,
        landmarks,
...
def main():
    ...
    while True:
        ...
        if pose_landmarks is not None:
            ...
            #     custom_connections,
            #     landmark_drawing_spec=custom_lm_styles
            # )
            debug_image = draw_bounding_rect(use_brect, debug_image, brect)
        ...
        if right_hand_landmarks is not None:
            ...
            #     'L',
            # )
            # draw_hand_v2(debug_image, results.right_hand_landmarks)
